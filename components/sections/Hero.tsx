          ...
          <div className="hidden lg:block">
            <div className="relative">
              ...
              <div className="relative z-10 bg-gradient-to-br from-primary/20 to-accent/20 rounded-3xl p-1">
                <div className="bg-gray-800/50 backdrop-blur-sm rounded-3xl aspect-[4/3] flex items-center justify-center">
                  <div className="text-center text-gray-400">
                    ...
                    <p className="text-sm">Fotky týmu / akce</p>
                    <p className="text-xs mt-1">(budou doplněny)</p>
                  </div>
                </div>
              </div>
